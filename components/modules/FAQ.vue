...
const faqItems = [
  ...
  },
  {
    ...
    answer:   'Штатный SMM-менеджер закрывает только соцсети. ДАН Медиа — это сразу сайт, бот, CRM и соцсети. Средняя зарплата SMM в Москве — 60 000–80 000 ₽/мес только за посты. За 50 000 ₽ у нас вы получаете полноценный digital-отдел: разработчик сайта + SMM + bot-разработчик + CRM-специалист в одном пакете.',
  },
  {
