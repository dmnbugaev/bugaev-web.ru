...
const faqItems = [
  ...
  },
  {
    ...
    answer:   'В подписку за 30 000 ₽/мес входит полный цифровой пакет без каких-либо скрытых доплат:',
    points: [
  ...
  },
  {
    ...
    answer:   'Штатный SMM-менеджер закрывает только соцсети. ДАН Медиа — это сразу сайт, бот, CRM и соцсети. Средняя зарплата SMM в Москве — 60 000–80 000 ₽/мес только за посты. За 30 000 ₽ у нас вы получаете полноценный digital-отдел: разработчик сайта + SMM + bot-разработчик + CRM-специалист в одном пакете.',
  },
  {
  ...
  {
    question: 'Как начать работу с ДАН Медиа?',
    answer:   'Всё просто: Напишите нам на сайте или напишите в Telegram @bugggd. Мы проведём бесплатный аудит вашего текущего digital-присутствия, согласуем план и уже через 2–3 дня запускаемся. Никаких долгих согласований и предоплат за несделанную работу.',
  },
]
</script>
