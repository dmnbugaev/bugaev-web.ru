          ...
          <Transition name="success">
            <div v-if="isSuccess" class="success-notification text-center py-10">
              ...
              <div class="flex flex-col sm:flex-row gap-3 justify-center">
                <a href="https://t.me/bugggd" target="_blank" rel="noopener noreferrer" class="btn-primary">
            ...
            <div class="space-y-5">
              ...
              <div class="grid sm:grid-cols-2 gap-5">
                <div>
                  <div class="floating-group">
                    ...
                    />
                    <label for="lead-name" class="floating-label">
                      Имя <span style="color: #D94F4F;" aria-hidden="true">*</span>
                    </label>
                  </div>
                  <Transition name="err">
                    <p v-if="errors.name" id="lead-name-error" role="alert" class="mt-1.5 text-xs flex items-center gap-1" style="color: #D94F4F;">
                ...
                <div>
                  <div class="floating-group">
                    ...
                    />
                    <label for="lead-phone" class="floating-label">
                      Телефон <span style="color: #D94F4F;" aria-hidden="true">*</span>
                    </label>
                  </div>
                  <Transition name="err">
                    <p v-if="errors.phone" id="lead-phone-error" role="alert" class="mt-1.5 text-xs flex items-center gap-1" style="color: #D94F4F;">
                      <svg width="11" height="11" viewBox="0 0 11 11" fill="none" aria-hidden="true">
                        <circle cx="5.5" cy="5.5" r="4.5" stroke="currentColor" stroke-width="1.3" />
                        <path d="M5.5 3v2.5M5.5 7.5v.5" stroke="currentColor" stroke-width="1.3" stroke-linecap="round" />
                      </svg>
              ...
              <div>
                <div class="floating-group">
                  ...
                  />
                  <label for="lead-email" class="floating-label">
                    Email <span style="color: #D94F4F;" aria-hidden="true">*</span>
                  </label>
                </div>
                <Transition name="err">
                  <p v-if="errors.email" id="lead-email-error" role="alert" class="mt-1.5 text-xs flex items-center gap-1" style="color: #D94F4F;">
                    <svg width="11" height="11" viewBox="0 0 11 11" fill="none" aria-hidden="true">
                      <circle cx="5.5" cy="5.5" r="4.5" stroke="currentColor" stroke-width="1.3" />
                      <path d="M5.5 3v2.5M5.5 7.5v.5" stroke="currentColor" stroke-width="1.3" stroke-linecap="round" />
                    </svg>
              ...
              <div class="floating-group">
                ...
                />
                <label for="lead-salon" class="floating-label">
