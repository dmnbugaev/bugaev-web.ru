...
const features = [
  ...
  },
  {
    ...
    tags:        ['Instagram', 'Max','Telegram', 'Reels'],
    highlight:   false,
  },
  {
    icon:        IconCRM,
  ...
  },
  {
    ...
    description: 'Один человек координирует весь digital. Связь по рабочим вопросам, рекомендации по акциям и трендам, еженедельные отчёты — 7 дней в неделю.',
    tags:        ['Поддержка 24/7', 'Отчёты', 'Стратегия'],
    highlight:   true,
  },
]
</script>
