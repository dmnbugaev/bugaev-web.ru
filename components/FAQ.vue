...
const faqItems = [
  ...
  },
  {
    ...
    answer:   'Без штрафов. Уведомите за 30 дней — и договор закрыт.',
  },
  {
  ...
  },
  {
    ...
    answer:   'Работаем строго в рамках 152-ФЗ о персональных данных. Доступ к CRM и базе — только у вас и вашего личного менеджера. Данные клиентов никуда не передаются.',
  },
  {
    ...
    points: [
      ...
      'Личный менеджер в Telegram (7 дней в неделю)',
