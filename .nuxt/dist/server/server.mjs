import { shallowReactive, reactive, effectScope, getCurrentScope, hasInjectionContext, getCurrentInstance, inject, toRef, shallowRef, isReadonly, isRef, isShallow, isReactive, toRaw, defineComponent, provide, h, ref, Suspense, Fragment, resolveComponent, computed, unref, readonly, withCtx, createTextVNode, useSSRContext, nextTick, defineAsyncComponent, mergeProps, onErrorCaptured, onServerPrefetch, createVNode, resolveDynamicComponent, createApp } from "vue";
import { $fetch } from "D:/pr/bugaev_web/node_modules/ofetch/dist/node.mjs";
import { baseURL } from "#internal/nuxt/paths";
import { createHooks } from "D:/pr/bugaev_web/node_modules/nuxt/node_modules/hookable/dist/index.mjs";
import { getContext, executeAsync } from "D:/pr/bugaev_web/node_modules/unctx/dist/index.mjs";
import { sanitizeStatusCode, createError as createError$1 } from "D:/pr/bugaev_web/node_modules/h3/dist/index.mjs";
import { START_LOCATION, createMemoryHistory, createRouter, RouterView } from "vue-router";
import { defu } from "D:/pr/bugaev_web/node_modules/defu/dist/defu.mjs";
import { hasProtocol, joinURL, parseURL, encodePath, decodePath, withQuery, isScriptProtocol, parseQuery, withTrailingSlash, withoutTrailingSlash } from "D:/pr/bugaev_web/node_modules/ufo/dist/index.mjs";
...
const _routes = [
  {
    name: "index",
    path: "/",
    component: () => import("./_nuxt/index-DUI8ABDB.js")
  },
  {
    name: "terms",
    path: "/terms",
    component: () => import("./_nuxt/terms-DCuOwdpi.js")
  },
  {
    name: "oferta",
    path: "/oferta",
    component: () => import("./_nuxt/oferta-CQToZcM3.js")
  },
  {
    name: "cookies",
    path: "/cookies",
    component: () => import("./_nuxt/cookies-wsl83p8a.js")
  },
  {
    name: "privacy",
    path: "/privacy",
    component: () => import("./_nuxt/privacy-Dfww73KS.js")
  },
  {
    name: "requisites",
    path: "/requisites",
    component: () => import("./_nuxt/requisites-OGfFvucP.js")
  }
];
...
const consentStatus = ref("pending");
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    const stack = void 0;
    const _Error404 = defineAsyncComponent(() => import("./_nuxt/error-404-CjJbCK9X.js"));
    const _Error = defineAsyncComponent(() => import("./_nuxt/error-500-OI48FrJY.js"));
