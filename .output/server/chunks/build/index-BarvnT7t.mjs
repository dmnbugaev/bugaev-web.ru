import { defineComponent, mergeProps, createVNode, resolveDynamicComponent, ref, unref, h, reactive, readonly, useSSRContext } from 'vue';
...
const _sfc_main$b = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))} data-v-65cc83dc><div class="section-container" data-v-65cc83dc><div class="flex items-center justify-between h-14 md:h-16" data-v-65cc83dc><a href="#" class="flex items-center gap-2.5 group" data-v-65cc83dc><div class="w-8 h-8 rounded-xl flex items-center justify-center flex-shrink-0 transition-transform duration-200 group-hover:scale-105" style="${ssrRenderStyle({ "background": "var(--accent)" })}" data-v-65cc83dc><svg width="16" height="16" viewBox="0 0 18 18" fill="none" data-v-65cc83dc><path d="M4 14L9 3L14 14H4Z" fill="var(--ink)" data-v-65cc83dc></path><circle cx="9" cy="9.5" r="1.8" fill="var(--ink)" data-v-65cc83dc></circle></svg></div><span class="text-base font-bold tracking-tight" style="${ssrRenderStyle({ "color": "var(--ink)", "font-family": "'Syne', sans-serif", "letter-spacing": "-0.02em" })}" data-v-65cc83dc>Bugaev Web</span></a><nav class="hidden md:flex items-center gap-7" data-v-65cc83dc><!--[-->`);
      ssrRenderList(navLinks, (link) => {
        _push(`<a${ssrRenderAttr("href", link.href)} class="text-sm font-medium transition-colors duration-150" style="${ssrRenderStyle({ "color": "var(--ink-3)" })}" data-v-65cc83dc>${ssrInterpolate(link.label)}</a>`);
      });
      _push(`<!--]--></nav><div class="flex items-center gap-3" data-v-65cc83dc><a href="https://t.me/bugaev_web" target="_blank" rel="noopener noreferrer" class="hidden md:inline-flex btn-primary text-sm" style="${ssrRenderStyle({ "padding": "0.5rem 1.25rem" })}" data-v-65cc83dc><svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor" data-v-65cc83dc><path d="M12 0C5.373 0 0 5.373 0 12s5.373 12 12 12 12-5.373 12-12S18.627 0 12 0zm5.894 8.221-1.97 9.28c-.145.658-.537.818-1.084.508l-3-2.21-1.447 1.394c-.16.16-.295.295-.605.295l.213-3.053 5.56-5.023c.242-.213-.054-.333-.373-.12l-6.871 4.326-2.962-.924c-.643-.204-.657-.643.136-.953l11.57-4.461c.537-.194 1.006.131.833.941z" data-v-65cc83dc></path></svg> Telegram </a><button class="md:hidden flex flex-col items-center justify-center gap-1.5 w-9 h-9 rounded-lg transition-colors" style="${ssrRenderStyle(unref(mobileMenuOpen) ? "background: var(--surface-warm);" : "")}" aria-label="\u041E\u0442\u043A\u0440\u044B\u0442\u044C \u043C\u0435\u043D\u044E" data-v-65cc83dc><span class="${ssrRenderClass(["block w-[18px] h-0.5 rounded-full transition-all duration-300", unref(mobileMenuOpen) ? "rotate-45 translate-y-2" : ""])}" style="${ssrRenderStyle({ "background": "var(--ink)" })}" data-v-65cc83dc></span><span class="${ssrRenderClass(["block w-[18px] h-0.5 rounded-full transition-all duration-300", unref(mobileMenuOpen) ? "opacity-0 scale-x-0" : ""])}" style="${ssrRenderStyle({ "background": "var(--ink)" })}" data-v-65cc83dc></span><span class="${ssrRenderClass(["block w-[18px] h-0.5 rounded-full transition-all duration-300", unref(mobileMenuOpen) ? "-rotate-45 -translate-y-2" : ""])}" style="${ssrRenderStyle({ "background": "var(--ink)" })}" data-v-65cc83dc></span></button></div></div></div>`);
      if (unref(mobileMenuOpen)) {
        _push(`<div class="fixed inset-0 bg-black/20 backdrop-blur-sm z-40 md:hidden" data-v-65cc83dc></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`<div class="${ssrRenderClass(["mobile-menu fixed top-0 right-0 bottom-0 w-72 z-50 md:hidden", unref(mobileMenuOpen) ? "open" : ""])}" style="${ssrRenderStyle({ "background": "var(--surface)", "border-left": "1px solid var(--border)" })}" data-v-65cc83dc><div class="flex items-center justify-between px-5 py-4" style="${ssrRenderStyle({ "border-bottom": "1px solid var(--border)" })}" data-v-65cc83dc><div class="flex items-center gap-2.5" data-v-65cc83dc><div class="w-7 h-7 rounded-lg flex items-center justify-center" style="${ssrRenderStyle({ "background": "var(--accent)" })}" data-v-65cc83dc><svg width="14" height="14" viewBox="0 0 18 18" fill="none" data-v-65cc83dc><path d="M4 14L9 3L14 14H4Z" fill="var(--ink)" data-v-65cc83dc></path><circle cx="9" cy="9.5" r="1.8" fill="var(--ink)" data-v-65cc83dc></circle></svg></div><span class="font-bold text-sm" style="${ssrRenderStyle({ "color": "var(--ink)", "font-family": "'Syne', sans-serif" })}" data-v-65cc83dc>Bugaev Web</span></div><button class="w-8 h-8 flex items-center justify-center rounded-lg transition-colors" style="${ssrRenderStyle({ "background": "var(--surface-warm)" })}" data-v-65cc83dc><svg width="14" height="14" viewBox="0 0 14 14" fill="none" data-v-65cc83dc><path d="M1 1l12 12M13 1L1 13" stroke="var(--ink-3)" stroke-width="1.5" stroke-linecap="round" data-v-65cc83dc></path></svg></button></div><nav class="p-4 flex flex-col gap-1" data-v-65cc83dc><!--[-->`);
      ssrRenderList(navLinks, (link) => {
        _push(`<a${ssrRenderAttr("href", link.href)} class="flex items-center gap-3 px-3 py-2.5 rounded-xl text-sm font-medium transition-all duration-150" style="${ssrRenderStyle({ "color": "var(--ink-3)" })}" data-v-65cc83dc>${ssrInterpolate(link.label)}</a>`);
      });
      _push(`<!--]--></nav><div class="absolute bottom-0 left-0 right-0 p-4" style="${ssrRenderStyle({ "border-top": "1px solid var(--border)" })}" data-v-65cc83dc><a href="https://t.me/bugaev_web" target="_blank" rel="noopener noreferrer" class="btn-primary w-full justify-center text-sm" data-v-65cc83dc><svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor" data-v-65cc83dc><path d="M12 0C5.373 0 0 5.373 0 12s5.373 12 12 12 12-5.373 12-12S18.627 0 12 0zm5.894 8.221-1.97 9.28c-.145.658-.537.818-1.084.508l-3-2.21-1.447 1.394c-.16.16-.295.295-.605.295l.213-3.053 5.56-5.023c.242-.213-.054-.333-.373-.12l-6.871 4.326-2.962-.924c-.643-.204-.657-.643.136-.953l11.57-4.461c.537-.194 1.006.131.833.941z" data-v-65cc83dc></path></svg> \u041D\u0430\u043F\u0438\u0441\u0430\u0442\u044C \u0432 Telegram </a></div></div></header>`);
    };
  }
});
...
const __nuxt_component_0 = /* @__PURE__ */ _export_sfc(_sfc_main$b, [["__scopeId", "data-v-65cc83dc"]]);
const _sfc_main$a = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))}><div class="absolute pointer-events-none" style="${ssrRenderStyle({ "top": "5%", "right": "0", "width": "480px", "height": "480px", "border-radius": "50%", "background": "var(--accent-dim)", "filter": "blur(100px)", "transform": "translateX(30%)" })}"></div><div class="absolute pointer-events-none" style="${ssrRenderStyle({ "bottom": "15%", "left": "-80px", "width": "280px", "height": "280px", "border-radius": "50%", "background": "rgba(143,175,138,0.05)", "filter": "blur(80px)" })}"></div><div class="section-container relative z-10"><div class="grid lg:grid-cols-[1fr_340px] gap-12 xl:gap-20 items-start py-16 lg:py-24"><div><div class="mb-8" data-animate="fade-down" data-delay="100"><span class="badge"><span class="w-1.5 h-1.5 rounded-full flex-shrink-0" style="${ssrRenderStyle({ "background": "var(--accent)" })}"></span> \u0426\u0438\u0444\u0440\u043E\u0432\u043E\u0439 \u043F\u0430\u043A\u0435\u0442 \u0434\u043B\u044F \u0441\u0430\u043B\u043E\u043D\u043E\u0432 \u043A\u0440\u0430\u0441\u043E\u0442\u044B \xB7 \u041C\u043E\u0441\u043A\u0432\u0430 </span></div><h1 data-animate="fade-up" data-delay="150" style="${ssrRenderStyle({ "font-family": "'Syne', sans-serif", "font-weight": "800", "line-height": "0.93", "letter-spacing": "-0.04em", "color": "var(--ink)", "font-size": "clamp(3.2rem, 8.5vw, 7rem)", "margin-bottom": "1.75rem" })}"> \u0412\u0430\u0448<br> \u0443\u0434\u0430\u043B\u0451\u043D\u043D\u044B\u0439<br><span style="${ssrRenderStyle({ "color": "var(--accent)" })}">\u043E\u0442\u0434\u0435\u043B</span><br> \u043C\u0430\u0440\u043A\u0435\u0442\u0438\u043D\u0433\u0430 </h1><p data-animate="fade-up" data-delay="250" style="${ssrRenderStyle({ "font-size": "1rem", "line-height": "1.7", "color": "var(--ink-3)", "max-width": "380px", "margin-bottom": "2.25rem" })}"> \u0421\u0430\u0439\u0442, Telegram\u2011\u0431\u043E\u0442, \u0441\u043E\u0446\u0441\u0435\u0442\u0438 \u0438 CRM\xA0\u2014 \u043E\u0434\u043D\u0430 \u043F\u043E\u0434\u043F\u0438\u0441\u043A\u0430 \u0432\u043C\u0435\u0441\u0442\u043E \u0447\u0435\u0442\u044B\u0440\u0451\u0445 \u043F\u043E\u0434\u0440\u044F\u0434\u0447\u0438\u043A\u043E\u0432. \u0414\u043B\u044F \u0441\u0430\u043B\u043E\u043D\u043E\u0432 \u043A\u0440\u0430\u0441\u043E\u0442\u044B \u0438 \u043A\u043B\u0438\u043D\u0438\u043A. </p><div class="flex flex-wrap gap-3 mb-14" data-animate="fade-up" data-delay="350"><a href="#contact" class="btn-primary"> \u041E\u0441\u0442\u0430\u0432\u0438\u0442\u044C \u0437\u0430\u044F\u0432\u043A\u0443 <span style="${ssrRenderStyle({ "font-size": "1.15em", "line-height": "1" })}">\u2192</span></a><a href="#features" class="btn-outline"> \u0423\u0437\u043D\u0430\u0442\u044C \u043F\u043E\u0434\u0440\u043E\u0431\u043D\u0435\u0435 </a></div><div class="flex flex-wrap gap-2.5" data-animate="fade-up" data-delay="450"><!--[-->`);
      ssrRenderList(stats, (stat) => {
        _push(`<div class="flex items-center gap-2.5 px-4 py-2.5 rounded-full" style="${ssrRenderStyle({ "background": "var(--surface-warm)", "border": "1px solid var(--border)" })}"><span class="mono text-sm font-bold" style="${ssrRenderStyle({ "color": "var(--ink)" })}">${ssrInterpolate(stat.value)}</span><span class="text-xs" style="${ssrRenderStyle({ "color": "var(--ink-3)" })}">${ssrInterpolate(stat.label)}</span></div>`);
      });
      _push(`<!--]--></div></div><div class="hidden lg:flex flex-col gap-3 flex-shrink-0" data-animate="fade-left" data-delay="300"><div class="relative overflow-hidden rounded-2xl p-7" style="${ssrRenderStyle({ "background": "var(--ink)", "color": "white" })}"><div style="${ssrRenderStyle({ "position": "absolute", "top": "-60px", "right": "-60px", "width": "200px", "height": "200px", "border-radius": "50%", "background": "rgba(143,175,138,0.10)", "pointer-events": "none" })}"></div><p class="mono text-xs mb-5 relative z-10" style="${ssrRenderStyle({ "color": "rgba(255,255,255,0.35)", "letter-spacing": "0.09em", "text-transform": "uppercase" })}"> \u041F\u043E\u0434\u043F\u0438\u0441\u043A\u0430 / \u043C\u0435\u0441\u044F\u0446 </p><div class="flex items-end gap-1.5 mb-6 relative z-10"><span style="${ssrRenderStyle({ "font-family": "'Syne', sans-serif", "font-weight": "800", "font-size": "3.6rem", "line-height": "1", "letter-spacing": "-0.04em" })}">50 000</span><span class="text-xl font-semibold mb-1.5" style="${ssrRenderStyle({ "color": "rgba(255,255,255,0.4)" })}">\u20BD</span></div><ul class="space-y-2.5 mb-6 relative z-10"><!--[-->`);
      ...
      _push(`<!--]--></ul><a href="#contact" class="relative z-10 flex items-center justify-center gap-2 w-full py-3 rounded-xl text-sm font-semibold transition-all duration-200" style="${ssrRenderStyle({ "background": "var(--accent)", "color": "var(--ink)" })}"> \u041E\u0441\u0442\u0430\u0432\u0438\u0442\u044C \u0437\u0430\u044F\u0432\u043A\u0443 <span>\u2197</span></a></div><div class="rounded-2xl px-5 py-4 flex items-center justify-between" style="${ssrRenderStyle({ "background": "var(--surface-warm)", "border": "1px solid var(--border)" })}"><div><p class="mono text-xs mb-0.5" style="${ssrRenderStyle({ "color": "var(--ink-3)" })}">\u0412\u043D\u0435\u0434\u0440\u0435\u043D\u0438\u0435 \u0432 \u043F\u0435\u0440\u0432\u044B\u0439 \u043C\u0435\u0441\u044F\u0446</p><p class="text-sm font-semibold" style="${ssrRenderStyle({ "color": "var(--ink)" })}">\u0411\u0435\u0437 \u0434\u043E\u043F\u043B\u0430\u0442 \u0437\u0430 \u0437\u0430\u043F\u0443\u0441\u043A</p></div><span class="text-2xl" style="${ssrRenderStyle({ "color": "var(--accent)" })}">\u2713</span></div></div></div><div class="lg:hidden pb-16" data-animate="fade-up" data-delay="500"><div class="rounded-2xl p-6" style="${ssrRenderStyle({ "background": "var(--ink)" })}"><div class="flex items-end justify-between mb-5"><div><p class="mono text-xs mb-1" style="${ssrRenderStyle({ "color": "rgba(255,255,255,0.35)" })}">\u041F\u043E\u0434\u043F\u0438\u0441\u043A\u0430 / \u043C\u0435\u0441\u044F\u0446</p><span style="${ssrRenderStyle({ "font-family": "'Syne', sans-serif", "font-weight": "800", "font-size": "2.5rem", "line-height": "1", "letter-spacing": "-0.04em", "color": "white" })}">50 000 \u20BD</span></div><span class="badge-dark">\u0412\u0441\u0451 \u0432\u043A\u043B\u044E\u0447\u0435\u043D\u043E</span></div><a href="#contact" class="btn-accent w-full justify-center"> \u041E\u0441\u0442\u0430\u0432\u0438\u0442\u044C \u0437\u0430\u044F\u0432\u043A\u0443 \u2192 </a></div></div></div><div class="absolute bottom-0 left-0 right-0 h-24 pointer-events-none" style="${ssrRenderStyle({ "background": "linear-gradient(to bottom, transparent, var(--surface))" })}"></div></section>`);
    };
  }
});
    ...
    const features = [
      {
        ...
        description: "\u0411\u044B\u0441\u0442\u0440\u044B\u0439 \u043B\u0435\u043D\u0434\u0438\u043D\u0433 \u0441 \u043E\u043D\u043B\u0430\u0439\u043D-\u0437\u0430\u043F\u0438\u0441\u044C\u044E \u0438 SEO-\u043E\u043F\u0442\u0438\u043C\u0438\u0437\u0430\u0446\u0438\u0435\u0439. \u0415\u0436\u0435\u043C\u0435\u0441\u044F\u0447\u043D\u044B\u0435 \u043E\u0431\u043D\u043E\u0432\u043B\u0435\u043D\u0438\u044F \u0432\u043A\u043B\u044E\u0447\u0435\u043D\u044B.",
      ...
      },
      {
        ...
        description: "\u041E\u043D\u043B\u0430\u0439\u043D-\u0437\u0430\u043F\u0438\u0441\u044C, \u0430\u0432\u0442\u043E\u043D\u0430\u043F\u043E\u043C\u0438\u043D\u0430\u043D\u0438\u044F, \u0441\u0431\u043E\u0440 \u043E\u0442\u0437\u044B\u0432\u043E\u0432. \u0421\u043D\u0438\u0436\u0430\u0435\u0442 \u043D\u0435\u044F\u0432\u043A\u0438 \u043D\u0430 30\u201340%.",
        tags: ["Python", "\u0410\u0432\u0442\u043E\u0437\u0430\u043F\u0438\u0441\u044C", "\u0423\u0432\u0435\u0434\u043E\u043C\u043B\u0435\u043D\u0438\u044F"],
        highlight: false
      },
      {
        icon: IconSocial,
        title: "\u0412\u0435\u0434\u0435\u043D\u0438\u0435 \u0441\u043E\u0446\u0441\u0435\u0442\u0435\u0439",
        description: "\u041A\u043E\u043D\u0442\u0435\u043D\u0442-\u043F\u043B\u0430\u043D, \u0432\u0438\u0437\u0443\u0430\u043B, \u043E\u0442\u0432\u0435\u0442\u044B \u043D\u0430 \u043A\u043E\u043C\u043C\u0435\u043D\u0442\u0430\u0440\u0438\u0438 \u2014 Instagram + Telegram-\u043A\u0430\u043D\u0430\u043B.",
        tags: ["Instagram", "Telegram", "Reels"],
        highlight: false
      },
      {
        icon: IconCRM,
        title: "\u041D\u0430\u0441\u0442\u0440\u043E\u0439\u043A\u0430 CRM (YCLIENTS)",
        description: "\u0418\u043D\u0442\u0435\u0433\u0440\u0430\u0446\u0438\u044F \u0441 \u0431\u043E\u0442\u043E\u043C \u0438 \u0441\u0430\u0439\u0442\u043E\u043C, \u043F\u0435\u0440\u0435\u043D\u043E\u0441 \u0431\u0430\u0437\u044B \u043A\u043B\u0438\u0435\u043D\u0442\u043E\u0432. \u0412\u0441\u0451 \u0440\u0430\u0431\u043E\u0442\u0430\u0435\u0442 \u0432 \u0441\u0432\u044F\u0437\u043A\u0435.",
        tags: ["YCLIENTS", "CRM", "\u0418\u043D\u0442\u0435\u0433\u0440\u0430\u0446\u0438\u044F"],
        highlight: false
      },
      {
        icon: IconManager,
        title: "\u041B\u0438\u0447\u043D\u044B\u0439 \u043C\u0435\u043D\u0435\u0434\u0436\u0435\u0440",
        description: "\u041E\u0434\u0438\u043D \u0447\u0435\u043B\u043E\u0432\u0435\u043A \u043A\u043E\u043E\u0440\u0434\u0438\u043D\u0438\u0440\u0443\u0435\u0442 \u0432\u0441\u0451. \u041A\u043E\u043D\u0441\u0443\u043B\u044C\u0442\u0430\u0446\u0438\u0438, \u043E\u0442\u0447\u0451\u0442\u044B, \u0441\u0432\u044F\u0437\u044C 6 \u0434\u043D\u0435\u0439 \u0432 \u043D\u0435\u0434\u0435\u043B\u044E.",
        tags: ["\u041F\u043E\u0434\u0434\u0435\u0440\u0436\u043A\u0430 6/7", "Telegram", "\u041E\u0442\u0447\u0451\u0442\u044B"],
        highlight: true
      }
    ];
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))}><div class="section-container"><div class="mb-16"><div class="mb-5" data-animate="fade-down"><span class="badge-dark">\u0421\u043E\u0441\u0442\u0430\u0432 \u043F\u0430\u043A\u0435\u0442\u0430</span></div><h2 class="section-title-light mb-4" data-animate="fade-up" data-delay="100"> \u0412\u0441\u0451, \u0447\u0442\u043E \u043D\u0443\u0436\u043D\u043E<br> \u0434\u043B\u044F <span style="${ssrRenderStyle({ "color": "var(--accent)" })}">\u0441\u0442\u0430\u0431\u0438\u043B\u044C\u043D\u043E\u0433\u043E \u043F\u043E\u0442\u043E\u043A\u0430</span> \u043A\u043B\u0438\u0435\u043D\u0442\u043E\u0432 </h2><p class="section-subtitle-light max-w-lg" data-animate="fade-up" data-delay="200"> 5 \u043D\u0430\u043F\u0440\u0430\u0432\u043B\u0435\u043D\u0438\u0439 \u0432 \u043E\u0434\u043D\u043E\u0439 \u043F\u043E\u0434\u043F\u0438\u0441\u043A\u0435 \u2014 \u043F\u043E\u043B\u043D\u044B\u0439 \u0446\u0438\u0444\u0440\u043E\u0432\u043E\u0439 \u043E\u0445\u0432\u0430\u0442 \u0431\u0435\u0437 \u0434\u043E\u043F\u043B\u0430\u0442 </p></div><div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4"><!--[-->`);
...
const _sfc_main$8 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const steps = [
      {
        ...
        description: "\u041E\u0431\u0441\u0443\u0436\u0434\u0430\u0435\u043C \u0437\u0430\u0434\u0430\u0447\u0438, \u0441\u043E\u0431\u0438\u0440\u0430\u0435\u043C \u043A\u043E\u043D\u0442\u0435\u043D\u0442, \u0430\u043D\u0430\u043B\u0438\u0437\u0438\u0440\u0443\u0435\u043C \u043A\u043E\u043D\u043A\u0443\u0440\u0435\u043D\u0442\u043E\u0432 \u0438 \u0432\u044B\u0441\u0442\u0440\u0430\u0438\u0432\u0430\u0435\u043C \u0441\u0442\u0440\u0430\u0442\u0435\u0433\u0438\u044E.",
        points: [
          "\u0411\u0440\u0438\u0444\u0438\u043D\u0433 \u0438 \u0430\u043D\u0430\u043B\u0438\u0437 \u043A\u043E\u043D\u043A\u0443\u0440\u0435\u043D\u0442\u043E\u0432",
      ...
      },
      {
        week: "\u041D\u0435\u0434\u0435\u043B\u044F 2\u20133",
        title: "\u0412\u043D\u0435\u0434\u0440\u0435\u043D\u0438\u0435",
        description: "\u0417\u0430\u043F\u0443\u0441\u043A\u0430\u0435\u043C \u0441\u0430\u0439\u0442, \u0431\u043E\u0442\u0430, \u043D\u0430\u0441\u0442\u0440\u0430\u0438\u0432\u0430\u0435\u043C CRM \u0438 \u0441\u043E\u0446\u0441\u0435\u0442\u0438. \u0412\u0441\u0451 \u0437\u0430 \u043C\u0435\u0441\u044F\u0446 \u0431\u0435\u0437 \u0434\u043E\u043F\u043B\u0430\u0442.",
        points: [
          "\u0420\u0430\u0437\u0440\u0430\u0431\u043E\u0442\u043A\u0430 \u0438 \u0437\u0430\u043F\u0443\u0441\u043A \u0441\u0430\u0439\u0442\u0430",
          "\u041D\u0430\u0441\u0442\u0440\u043E\u0439\u043A\u0430 Telegram-\u0431\u043E\u0442\u0430",
          "\u0418\u043D\u0442\u0435\u0433\u0440\u0430\u0446\u0438\u044F CRM YCLIENTS"
        ]
      },
      {
        week: "\u041D\u0435\u0434\u0435\u043B\u044F 3\u20134",
        title: "\u0421\u0438\u0441\u0442\u0435\u043C\u0430 \u0432 \u0440\u0430\u0431\u043E\u0442\u0435",
        description: "\u0415\u0436\u0435\u043C\u0435\u0441\u044F\u0447\u043D\u043E\u0435 \u0432\u0435\u0434\u0435\u043D\u0438\u0435, \u043E\u0442\u0447\u0451\u0442\u044B, \u043E\u043F\u0442\u0438\u043C\u0438\u0437\u0430\u0446\u0438\u044F \u0432\u0441\u0435\u0445 \u043A\u0430\u043D\u0430\u043B\u043E\u0432 \u043F\u043E \u0434\u0430\u043D\u043D\u044B\u043C \u0430\u043D\u0430\u043B\u0438\u0442\u0438\u043A\u0438.",
        points: [
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))}><div class="section-container"><div class="mb-16"><div class="mb-5" data-animate="fade-down"><span class="badge">\u041F\u0440\u043E\u0446\u0435\u0441\u0441 \u0437\u0430\u043F\u0443\u0441\u043A\u0430</span></div><h2 class="section-title mb-4" data-animate="fade-up" data-delay="100"> \u041C\u0435\u0441\u044F\u0446 \u2014 \u0438 \u0441\u0438\u0441\u0442\u0435\u043C\u0430<br>\u0440\u0430\u0431\u043E\u0442\u0430\u0435\u0442 \u043D\u0430 \u0432\u0430\u0441 </h2><p class="section-subtitle max-w-md" data-animate="fade-up" data-delay="200"> \u0427\u0451\u0442\u043A\u0438\u0439 \u043F\u043B\u0430\u043D \u043E\u0442 \u043E\u043D\u0431\u043E\u0440\u0434\u0438\u043D\u0433\u0430 \u0434\u043E \u043F\u0435\u0440\u0432\u044B\u0445 \u0440\u0435\u0437\u0443\u043B\u044C\u0442\u0430\u0442\u043E\u0432 \u2014 \u0431\u0435\u0437 \u0432\u0430\u0448\u0435\u0433\u043E \u043F\u043E\u0433\u0440\u0443\u0436\u0435\u043D\u0438\u044F \u0432 \u0434\u0435\u0442\u0430\u043B\u0438 </p></div><div class="hidden md:grid grid-cols-3 gap-5" data-animate="fade-up" data-delay="280"><!--[-->`);
...
const _sfc_main$7 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))}><div class="section-container"><div class="mb-14"><div class="mb-5" data-animate="fade-down"><span class="badge">\u041D\u0430\u0448\u0438 \u043A\u043B\u0438\u0435\u043D\u0442\u044B</span></div><h2 class="section-title mb-4" data-animate="fade-up" data-delay="100"> \u0418\u0434\u0435\u0430\u043B\u044C\u043D\u043E \u043F\u043E\u0434\u0445\u043E\u0434\u0438\u0442 \u0434\u043B\u044F </h2><p class="section-subtitle max-w-lg" data-animate="fade-up" data-delay="200"> \u0415\u0441\u043B\u0438 \u0432\u044B \u0443\u0441\u0442\u0430\u043B\u0438 \u043D\u0430\u043D\u0438\u043C\u0430\u0442\u044C \u0444\u0440\u0438\u043B\u0430\u043D\u0441\u0435\u0440\u043E\u0432 \u043F\u043E \u043E\u0442\u0434\u0435\u043B\u044C\u043D\u043E\u0441\u0442\u0438 \u0438 \u0445\u043E\u0442\u0438\u0442\u0435 \u043E\u0434\u0438\u043D \u043F\u043E\u043D\u044F\u0442\u043D\u044B\u0439 \u0431\u044E\u0434\u0436\u0435\u0442 \u2014 \u044D\u0442\u043E\u0442 \u0430\u0431\u043E\u043D\u0435\u043C\u0435\u043D\u0442 \u0434\u043B\u044F \u0432\u0430\u0441. </p></div><div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-10" data-animate="fade-up" data-delay="280"><!--[-->`);
      ...
      _push(`<!--]--></div><div class="rounded-2xl p-8 md:p-10 flex flex-col md:flex-row items-start md:items-center justify-between gap-6" style="${ssrRenderStyle({ "background": "var(--surface)", "border": "1px solid var(--border)" })}" data-animate="fade-up" data-delay="400"><div><h3 class="text-xl font-bold mb-2" style="${ssrRenderStyle({ "color": "var(--ink)", "letter-spacing": "-0.02em" })}">\u0413\u043E\u0442\u043E\u0432\u044B \u043E\u0431\u0441\u0443\u0434\u0438\u0442\u044C?</h3><p class="text-sm" style="${ssrRenderStyle({ "color": "var(--ink-3)" })}"> \u041E\u0441\u0442\u0430\u0432\u044C\u0442\u0435 \u0437\u0430\u044F\u0432\u043A\u0443 \u2014 \u043F\u0440\u043E\u0432\u0435\u0434\u0451\u043C \u0431\u0435\u0441\u043F\u043B\u0430\u0442\u043D\u044B\u0439 \u0430\u0443\u0434\u0438\u0442 \u0438 \u0441\u043E\u0441\u0442\u0430\u0432\u0438\u043C \u043F\u043B\u0430\u043D </p></div><div class="flex flex-col sm:flex-row gap-3 flex-shrink-0"><a href="#contact" class="btn-primary whitespace-nowrap"> \u041E\u0441\u0442\u0430\u0432\u0438\u0442\u044C \u0437\u0430\u044F\u0432\u043A\u0443 </a><a href="https://t.me/bugaev_web" target="_blank" rel="noopener noreferrer" class="btn-outline whitespace-nowrap"> Telegram \u2197 </a></div></div></div></section>`);
    };
  }
});
...
const _sfc_main$5 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const whyItems = [
      {
        problem: "\u0420\u0430\u0437\u0440\u043E\u0437\u043D\u0435\u043D\u043D\u044B\u0435 \u043F\u043E\u0434\u0440\u044F\u0434\u0447\u0438\u043A\u0438",
        solution: "\u041E\u0434\u043D\u043E \u0440\u0435\u0448\u0435\u043D\u0438\u0435 \u043F\u043E\u0434 \u043A\u043B\u044E\u0447",
        detail: "\u0421\u0430\u0439\u0442, \u0431\u043E\u0442, \u0441\u043E\u0446\u0441\u0435\u0442\u0438 \u0438 CRM \u0432 \u043E\u0434\u043D\u043E\u0439 \u043A\u043E\u043C\u0430\u043D\u0434\u0435 \u2014 \u0431\u0435\u0437 \u0440\u0430\u0437\u0440\u043E\u0437\u043D\u0435\u043D\u043D\u044B\u0445 \u0441\u0447\u0435\u0442\u043E\u0432 \u0438 \u0441\u043E\u0433\u043B\u0430\u0441\u043E\u0432\u0430\u043D\u0438\u0439."
      },
      {
        problem: "\u041D\u0435\u0442 \u0432\u0440\u0435\u043C\u0435\u043D\u0438 \u043D\u0430 \u0441\u043E\u0446\u0441\u0435\u0442\u0438",
        solution: "\u041C\u044B \u0432\u0435\u0434\u0451\u043C \u0432\u043C\u0435\u0441\u0442\u043E \u0432\u0430\u0441",
        detail: "\u041A\u043E\u043D\u0442\u0435\u043D\u0442-\u043F\u043B\u0430\u043D, \u043F\u043E\u0441\u0442\u044B, \u0441\u0442\u043E\u0440\u0438\u0441, \u043E\u0442\u0432\u0435\u0442\u044B \u043D\u0430 \u043A\u043E\u043C\u043C\u0435\u043D\u0442\u0430\u0440\u0438\u0438 \u2014 10\u201315 \u043C\u0438\u043D\u0443\u0442 \u043E\u0442 \u0432\u0430\u0441 \u0432 \u043D\u0435\u0434\u0435\u043B\u044E."
      },
      {
        problem: "\u0421\u0442\u0440\u0430\u0445 \u0443\u0434\u0430\u043B\u0451\u043D\u043A\u0438",
        solution: "\u041F\u0440\u043E\u0437\u0440\u0430\u0447\u043D\u0430\u044F \u043E\u0442\u0447\u0451\u0442\u043D\u043E\u0441\u0442\u044C",
        detail: "\u0415\u0436\u0435\u043D\u0435\u0434\u0435\u043B\u044C\u043D\u044B\u0435 \u043E\u0442\u0447\u0451\u0442\u044B \u0432 Telegram, \u0432\u0438\u0434\u0438\u0442\u0435 \u043A\u0430\u0436\u0434\u043E\u0435 \u0434\u0435\u0439\u0441\u0442\u0432\u0438\u0435 \u0438 \u0440\u0435\u0437\u0443\u043B\u044C\u0442\u0430\u0442."
      },
      {
        problem: "\u0414\u043E\u0440\u043E\u0433\u043E\u0439 \u0448\u0442\u0430\u0442\u043D\u044B\u0439 SMM",
        solution: "50 000 \u20BD \u2014 \u0432\u0441\u0451 \u0432\u043A\u043B\u044E\u0447\u0435\u043D\u043E",
        detail: "\u041F\u043E\u043B\u043D\u044B\u0439 \u0448\u0442\u0430\u0442 \u043E\u0431\u043E\u0439\u0434\u0451\u0442\u0441\u044F \u0432 3\u20135\xD7 \u0434\u043E\u0440\u043E\u0436\u0435. \u041C\u044B \u044D\u0444\u0444\u0435\u043A\u0442\u0438\u0432\u043D\u0435\u0435 \u0438 \u0441\u043F\u0435\u0446\u0438\u0430\u043B\u0438\u0437\u0438\u0440\u043E\u0432\u0430\u043D\u043D\u0435\u0435."
      }
    ];
    const teamStats = [
...
const _sfc_main$4 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    const testimonials = [
      {
        text: "\u0421\u0430\u0439\u0442 \u043E\u043A\u0443\u043F\u0438\u043B\u0441\u044F \u0432 \u043F\u0435\u0440\u0432\u0443\u044E \u043D\u0435\u0434\u0435\u043B\u044E, \u0437\u0430\u043F\u0438\u0441\u0438 \u0447\u0435\u0440\u0435\u0437 \u0431\u043E\u0442\u0430 \u0430\u0432\u0442\u043E\u043C\u0430\u0442\u0438\u0437\u0438\u0440\u043E\u0432\u0430\u043B\u0438 30% \u043A\u043B\u0438\u0435\u043D\u0442\u043E\u0432. \u0421\u043F\u0430\u0441\u0438\u0431\u043E, Bugaev Web!",
        result: "+40% \u0437\u0430\u043F\u0438\u0441\u0435\u0439 \u0447\u0435\u0440\u0435\u0437 \u0441\u0430\u0439\u0442 \u0437\u0430 1 \u043C\u0435\u0441\u044F\u0446",
        name: "\u0410\u043D\u043D\u0430 \u0421\u043E\u043A\u043E\u043B\u043E\u0432\u0430",
        role: "\u0412\u043B\u0430\u0434\u0435\u043B\u0438\u0446\u0430, \u0441\u0442\u0443\u0434\u0438\u044F \xABPrism Beauty\xBB, \u041C\u043E\u0441\u043A\u0432\u0430",
        initials: "\u0410\u0421",
        color1: "#8FAF8A",
        color2: "#5A7A56"
      },
      {
        text: "\u0420\u0430\u043D\u044C\u0448\u0435 \u0441\u0430\u043C\u0430 \u0432\u0435\u043B\u0430 Instagram, \u0432\u044B\u0433\u043E\u0440\u0430\u043B\u0430. \u0422\u0435\u043F\u0435\u0440\u044C \u0441\u043E\u0446\u0441\u0435\u0442\u0438 \u0432\u0435\u0434\u0443\u0442 \u043F\u0440\u043E\u0444\u0435\u0441\u0441\u0438\u043E\u043D\u0430\u043B\u044B, \u0430 \u044F \u0437\u0430\u043D\u0438\u043C\u0430\u044E\u0441\u044C \u0431\u0438\u0437\u043D\u0435\u0441\u043E\u043C. \u041A\u043B\u0438\u0435\u043D\u0442\u043E\u0432 \u0441\u0442\u0430\u043B\u043E \u0431\u043E\u043B\u044C\u0448\u0435.",
        result: "+3400 \u0436\u0438\u0432\u044B\u0445 \u043F\u043E\u0434\u043F\u0438\u0441\u0447\u0438\u043A\u043E\u0432 \u0437\u0430 4 \u043C\u0435\u0441\u044F\u0446\u0430",
        name: "\u041C\u0430\u0440\u0438\u043D\u0430 \u041A\u043E\u0432\u0430\u043B\u0451\u0432\u0430",
        role: "\u0414\u0438\u0440\u0435\u043A\u0442\u043E\u0440, \u043A\u043B\u0438\u043D\u0438\u043A\u0430 \xAB\u042D\u0441\u0442\u0435\u0442\u0438\u043A\u0430\xBB, \u0421\u041F\u0431",
        initials: "\u041C\u041A",
        color1: "#C9B8A8",
        color2: "#9E7B7B"
      },
      {
        text: "CRM \u0431\u044B\u043B\u043E \u0441\u0442\u0440\u0430\u0448\u043D\u043E \u043D\u0430\u0441\u0442\u0440\u0430\u0438\u0432\u0430\u0442\u044C \u0441\u0430\u043C\u043E\u0441\u0442\u043E\u044F\u0442\u0435\u043B\u044C\u043D\u043E. \u0422\u0435\u043F\u0435\u0440\u044C \u043A\u043B\u0438\u0435\u043D\u0442\u044B \u043F\u043E\u043B\u0443\u0447\u0430\u044E\u0442 \u043D\u0430\u043F\u043E\u043C\u0438\u043D\u0430\u043D\u0438\u044F \u0430\u0432\u0442\u043E\u043C\u0430\u0442\u0438\u0447\u0435\u0441\u043A\u0438, \u043E\u0442\u043C\u0435\u043D\u044B \u0441\u043D\u0438\u0437\u0438\u043B\u0438\u0441\u044C \u0441 25% \u0434\u043E 8%.",
        result: "\u041E\u0442\u043C\u0435\u043D\u044B \u0437\u0430\u043F\u0438\u0441\u0435\u0439 \u0441\u043D\u0438\u0437\u0438\u043B\u0438\u0441\u044C \u0441 25% \u0434\u043E 8%",
        name: "\u0414\u043C\u0438\u0442\u0440\u0438\u0439 \u041E\u0440\u043B\u043E\u0432",
        role: "\u0412\u043B\u0430\u0434\u0435\u043B\u0435\u0446, \u0431\u0430\u0440\u0431\u0435\u0440\u0448\u043E\u043F \xABNordCut\xBB, \u0415\u043A\u0431",
        initials: "\u0414\u041E",
        color1: "#3A3A3A",
        color2: "#8FAF8A"
      }
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<section${ssrRenderAttrs(mergeProps({
        ...
        class: "py-24",
        style: { "background": "var(--surface)" }
      }, _attrs))}><div class="section-container"><div class="mb-14"><div class="mb-5" data-animate="fade-down"><span class="badge">\u041E\u0442\u0437\u044B\u0432\u044B \u043A\u043B\u0438\u0435\u043D\u0442\u043E\u0432</span></div><h2 class="section-title mb-3" data-animate="fade-up" data-delay="100"> \u0420\u0435\u0437\u0443\u043B\u044C\u0442\u0430\u0442\u044B \u043D\u0430\u0448\u0438\u0445 \u043A\u043B\u0438\u0435\u043D\u0442\u043E\u0432 </h2><p class="section-subtitle" data-animate="fade-up" data-delay="200"> \u0420\u0435\u0430\u043B\u044C\u043D\u044B\u0435 \u0438\u0441\u0442\u043E\u0440\u0438\u0438 \u0440\u043E\u0441\u0442\u0430 \u2014 \u0431\u0435\u0437 \u043B\u0438\u0448\u043D\u0438\u0445 \u043E\u0431\u0435\u0449\u0430\u043D\u0438\u0439 </p></div><div class="grid md:grid-cols-3 gap-5"><!--[-->`);
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<section${ssrRenderAttrs(mergeProps({
        ...
        class: "py-24",
        style: { "background": "var(--surface-warm)" }
      }, _attrs))}><div class="section-container"><div class="text-center mb-14"><div class="flex justify-center mb-5" data-animate="fade-down"><span class="badge">\u0412\u043E\u043F\u0440\u043E\u0441\u044B \u0438 \u043E\u0442\u0432\u0435\u0442\u044B</span></div><h2 class="section-title mb-3" data-animate="fade-up" data-delay="100"> \u0427\u0430\u0441\u0442\u043E \u0437\u0430\u0434\u0430\u0432\u0430\u0435\u043C\u044B\u0435 \u0432\u043E\u043F\u0440\u043E\u0441\u044B </h2><p class="section-subtitle" data-animate="fade-up" data-delay="200"> \u0415\u0441\u043B\u0438 \u043D\u0435 \u043D\u0430\u0448\u043B\u0438 \u043E\u0442\u0432\u0435\u0442 \u2014 \u043D\u0430\u043F\u0438\u0448\u0438\u0442\u0435 \u043D\u0430\u043C \u0432 Telegram, \u043E\u0442\u0432\u0435\u0442\u0438\u043C \u0432 \u0442\u0435\u0447\u0435\u043D\u0438\u0435 \u0447\u0430\u0441\u0430 </p></div><div class="max-w-3xl mx-auto flex flex-col gap-2" data-animate="fade-up" data-delay="300"><!--[-->`);
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<section${ssrRenderAttrs(mergeProps({
        ...
        class: "py-24",
        style: { "background": "var(--surface)" }
      }, _attrs))} data-v-d7d46793><div class="section-container" data-v-d7d46793><div class="max-w-2xl mx-auto" data-v-d7d46793><div class="text-center mb-10" data-v-d7d46793><div class="flex justify-center mb-5" data-animate="fade-down" data-v-d7d46793><span class="badge" data-v-d7d46793>\u0411\u044B\u0441\u0442\u0440\u044B\u0439 \u0441\u0442\u0430\u0440\u0442</span></div><h2 class="section-title mb-3" data-animate="fade-up" data-delay="100" data-v-d7d46793> \u041E\u0441\u0442\u0430\u0432\u044C\u0442\u0435 \u0437\u0430\u044F\u0432\u043A\u0443 \u2014 \u0438 \u043C\u044B \u0441\u0432\u044F\u0436\u0435\u043C\u0441\u044F \u0441 \u0432\u0430\u043C\u0438 \u0437\u0430 \u0447\u0430\u0441 </h2><p class="section-subtitle" data-animate="fade-up" data-delay="200" data-v-d7d46793> \u0420\u0430\u0441\u0441\u043A\u0430\u0436\u0438\u0442\u0435 \u043E \u0441\u0435\u0431\u0435, \u0438 \u043C\u044B \u043F\u043E\u0434\u0433\u043E\u0442\u043E\u0432\u0438\u043C \u0438\u043D\u0434\u0438\u0432\u0438\u0434\u0443\u0430\u043B\u044C\u043D\u043E\u0435 \u043F\u0440\u0435\u0434\u043B\u043E\u0436\u0435\u043D\u0438\u0435 </p></div><div class="rounded-3xl p-8 md:p-10" style="${ssrRenderStyle({ "background": "var(--surface)", "border": "1px solid var(--border)", "box-shadow": "0 4px 40px rgba(0,0,0,0.06)" })}" data-animate="fade-up" data-delay="300" data-v-d7d46793>`);
      if (unref(isSuccess)) {
        _push(`<div class="success-notification text-center py-10" data-v-d7d46793><div class="w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-5" style="${ssrRenderStyle({ "background": "var(--accent-dim)", "border": "2px solid rgba(143,175,138,0.3)" })}" data-v-d7d46793><svg width="26" height="26" viewBox="0 0 26 26" fill="none" data-v-d7d46793><path d="M4 13l6 6 12-12" stroke="var(--accent-text)" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" data-v-d7d46793></path></svg></div><h3 class="text-2xl font-bold mb-3" style="${ssrRenderStyle({ "color": "var(--ink)", "letter-spacing": "-0.02em" })}" data-v-d7d46793>\u0417\u0430\u044F\u0432\u043A\u0430 \u043E\u0442\u043F\u0440\u0430\u0432\u043B\u0435\u043D\u0430!</h3><p class="text-base mb-8 leading-relaxed" style="${ssrRenderStyle({ "color": "var(--ink-3)" })}" data-v-d7d46793> \u041C\u044B \u043F\u043E\u043B\u0443\u0447\u0438\u043B\u0438 \u0432\u0430\u0448\u0443 \u0437\u0430\u044F\u0432\u043A\u0443 \u0438 \u0441\u0432\u044F\u0436\u0435\u043C\u0441\u044F \u0441 \u0432\u0430\u043C\u0438 \u0432 \u0442\u0435\u0447\u0435\u043D\u0438\u0435 <strong style="${ssrRenderStyle({ "color": "var(--ink)" })}" data-v-d7d46793>\u043E\u0434\u043D\u043E\u0433\u043E \u0447\u0430\u0441\u0430</strong>. \u0418\u043B\u0438 \u043D\u0430\u043F\u0438\u0448\u0438\u0442\u0435 \u043D\u0430\u043C \u043D\u0430\u043F\u0440\u044F\u043C\u0443\u044E \u0432 Telegram. </p><div class="flex flex-col sm:flex-row gap-3 justify-center" data-v-d7d46793><a href="https://t.me/bugaev_web" target="_blank" rel="noopener noreferrer" class="btn-primary" data-v-d7d46793><svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor" data-v-d7d46793><path d="M12 0C5.373 0 0 5.373 0 12s5.373 12 12 12 12-5.373 12-12S18.627 0 12 0zm5.894 8.221-1.97 9.28c-.145.658-.537.818-1.084.508l-3-2.21-1.447 1.394c-.16.16-.295.295-.605.295l.213-3.053 5.56-5.023c.242-.213-.054-.333-.373-.12l-6.871 4.326-2.962-.924c-.643-.204-.657-.643.136-.953l11.57-4.461c.537-.194 1.006.131.833.941z" data-v-d7d46793></path></svg> \u041D\u0430\u043F\u0438\u0441\u0430\u0442\u044C \u0432 Telegram </a><button class="btn-outline" data-v-d7d46793>\u041E\u0442\u043F\u0440\u0430\u0432\u0438\u0442\u044C \u0435\u0449\u0451 \u043E\u0434\u043D\u0443</button></div></div>`);
      } else {
        _push(`<!---->`);
      }
      if (!unref(isSuccess)) {
        _push(`<form novalidate data-v-d7d46793><div class="space-y-5" data-v-d7d46793><div class="grid sm:grid-cols-2 gap-5" data-v-d7d46793><div data-v-d7d46793><label class="block text-sm font-semibold mb-2" style="${ssrRenderStyle({ "color": "var(--ink)" })}" data-v-d7d46793> \u0418\u043C\u044F <span style="${ssrRenderStyle({ "color": "#D94F4F" })}" data-v-d7d46793>*</span></label><input${ssrRenderAttr("value", unref(form).name)} type="text" placeholder="\u0410\u043D\u043D\u0430" autocomplete="given-name" class="${ssrRenderClass(["form-input", unref(errors).name ? "error" : ""])}" data-v-d7d46793>`);
        if (unref(errors).name) {
          _push(`<p class="mt-1.5 text-xs flex items-center gap-1" style="${ssrRenderStyle({ "color": "#D94F4F" })}" data-v-d7d46793><svg width="11" height="11" viewBox="0 0 11 11" fill="none" data-v-d7d46793><circle cx="5.5" cy="5.5" r="4.5" stroke="currentColor" stroke-width="1.3" data-v-d7d46793></circle><path d="M5.5 3v2.5M5.5 7.5v.5" stroke="currentColor" stroke-width="1.3" stroke-linecap="round" data-v-d7d46793></path></svg> ${ssrInterpolate(unref(errors).name)}</p>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div><div data-v-d7d46793><label class="block text-sm font-semibold mb-2" style="${ssrRenderStyle({ "color": "var(--ink)" })}" data-v-d7d46793> \u0422\u0435\u043B\u0435\u0444\u043E\u043D <span style="${ssrRenderStyle({ "color": "#D94F4F" })}" data-v-d7d46793>*</span></label><input${ssrRenderAttr("value", unref(form).phone)} type="tel" placeholder="+7 (999) 000-00-00" autocomplete="tel" class="${ssrRenderClass(["form-input", unref(errors).phone ? "error" : ""])}" data-v-d7d46793>`);
        if (unref(errors).phone) {
          _push(`<p class="mt-1.5 text-xs flex items-center gap-1" style="${ssrRenderStyle({ "color": "#D94F4F" })}" data-v-d7d46793><svg width="11" height="11" viewBox="0 0 11 11" fill="none" data-v-d7d46793><circle cx="5.5" cy="5.5" r="4.5" stroke="currentColor" stroke-width="1.3" data-v-d7d46793></circle><path d="M5.5 3v2.5M5.5 7.5v.5" stroke="currentColor" stroke-width="1.3" stroke-linecap="round" data-v-d7d46793></path></svg> ${ssrInterpolate(unref(errors).phone)}</p>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div></div><div data-v-d7d46793><label class="block text-sm font-semibold mb-2" style="${ssrRenderStyle({ "color": "var(--ink)" })}" data-v-d7d46793> Email <span style="${ssrRenderStyle({ "color": "#D94F4F" })}" data-v-d7d46793>*</span></label><input${ssrRenderAttr("value", unref(form).email)} type="email" placeholder="anna@mysalon.ru" autocomplete="email" class="${ssrRenderClass(["form-input", unref(errors).email ? "error" : ""])}" data-v-d7d46793>`);
        if (unref(errors).email) {
          _push(`<p class="mt-1.5 text-xs flex items-center gap-1" style="${ssrRenderStyle({ "color": "#D94F4F" })}" data-v-d7d46793><svg width="11" height="11" viewBox="0 0 11 11" fill="none" data-v-d7d46793><circle cx="5.5" cy="5.5" r="4.5" stroke="currentColor" stroke-width="1.3" data-v-d7d46793></circle><path d="M5.5 3v2.5M5.5 7.5v.5" stroke="currentColor" stroke-width="1.3" stroke-linecap="round" data-v-d7d46793></path></svg> ${ssrInterpolate(unref(errors).email)}</p>`);
        } else {
          _push(`<!---->`);
        }
        _push(`</div><div data-v-d7d46793><label class="block text-sm font-semibold mb-2" style="${ssrRenderStyle({ "color": "var(--ink)" })}" data-v-d7d46793> \u041D\u0430\u0437\u0432\u0430\u043D\u0438\u0435 \u0441\u0430\u043B\u043E\u043D\u0430 / \u043A\u043B\u0438\u043D\u0438\u043A\u0438 <span class="font-normal" style="${ssrRenderStyle({ "color": "var(--ink-3)" })}" data-v-d7d46793>(\u043D\u0435\u043E\u0431\u044F\u0437\u0430\u0442\u0435\u043B\u044C\u043D\u043E)</span></label><input${ssrRenderAttr("value", unref(form).salon)} type="text" placeholder="\u0421\u0442\u0443\u0434\u0438\u044F Prism Beauty" autocomplete="organization" class="form-input" data-v-d7d46793></div><input type="hidden" name="utm_source"${ssrRenderAttr("value", unref(utmParams2).utm_source)} data-v-d7d46793><input type="hidden" name="utm_medium"${ssrRenderAttr("value", unref(utmParams2).utm_medium)} data-v-d7d46793><input type="hidden" name="utm_campaign"${ssrRenderAttr("value", unref(utmParams2).utm_campaign)} data-v-d7d46793><input type="hidden" name="utm_term"${ssrRenderAttr("value", unref(utmParams2).utm_term)} data-v-d7d46793><input type="hidden" name="utm_content"${ssrRenderAttr("value", unref(utmParams2).utm_content)} data-v-d7d46793>`);
        if (unref(isError)) {
          _push(`<div class="p-4 rounded-xl flex items-start gap-3" style="${ssrRenderStyle({ "background": "rgba(217,79,79,0.05)", "border": "1px solid rgba(217,79,79,0.18)" })}" data-v-d7d46793><svg width="15" height="15" viewBox="0 0 15 15" fill="none" class="flex-shrink-0 mt-0.5" data-v-d7d46793><circle cx="7.5" cy="7.5" r="6.5" stroke="#D94F4F" stroke-width="1.3" data-v-d7d46793></circle><path d="M7.5 4.5v3M7.5 9.5v.5" stroke="#D94F4F" stroke-width="1.3" stroke-linecap="round" data-v-d7d46793></path></svg><p class="text-sm" style="${ssrRenderStyle({ "color": "#D94F4F" })}" data-v-d7d46793>${ssrInterpolate(unref(errorMessage))}</p></div>`);
        } else {
          _push(`<!---->`);
        }
        _push(`<button type="submit"${ssrIncludeBooleanAttr(unref(isSubmitting)) ? " disabled" : ""} class="btn-primary w-full text-base py-4 disabled:opacity-60 disabled:cursor-not-allowed disabled:transform-none disabled:shadow-none" data-v-d7d46793>`);
        if (!unref(isSubmitting)) {
          _push(`<span class="flex items-center gap-2 justify-center" data-v-d7d46793> \u041E\u0442\u043F\u0440\u0430\u0432\u0438\u0442\u044C \u0437\u0430\u044F\u0432\u043A\u0443 <span style="${ssrRenderStyle({ "font-size": "1.1em" })}" data-v-d7d46793>\u2192</span></span>`);
        } else {
          _push(`<span class="flex items-center gap-2 justify-center" data-v-d7d46793><span class="spinner" data-v-d7d46793></span> \u041E\u0442\u043F\u0440\u0430\u0432\u043B\u044F\u0435\u043C... </span>`);
        }
        _push(`</button></div><p class="text-xs text-center mt-4 leading-relaxed" style="${ssrRenderStyle({ "color": "var(--ink-3)" })}" data-v-d7d46793> \u041D\u0430\u0436\u0438\u043C\u0430\u044F \xAB\u041E\u0442\u043F\u0440\u0430\u0432\u0438\u0442\u044C \u0437\u0430\u044F\u0432\u043A\u0443\xBB, \u0432\u044B \u0441\u043E\u0433\u043B\u0430\u0448\u0430\u0435\u0442\u0435\u0441\u044C \u0441 <a href="#" class="underline" style="${ssrRenderStyle({ "color": "var(--ink)" })}" data-v-d7d46793>\u043F\u043E\u043B\u0438\u0442\u0438\u043A\u043E\u0439 \u043A\u043E\u043D\u0444\u0438\u0434\u0435\u043D\u0446\u0438\u0430\u043B\u044C\u043D\u043E\u0441\u0442\u0438</a>. \u0414\u0430\u043D\u043D\u044B\u0435 \u043D\u0435 \u043F\u0435\u0440\u0435\u0434\u0430\u044E\u0442\u0441\u044F \u0442\u0440\u0435\u0442\u044C\u0438\u043C \u043B\u0438\u0446\u0430\u043C. </p></form>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div><div class="mt-6 text-center" data-animate="fade-up" data-delay="400" data-v-d7d46793><p class="text-sm mb-2" style="${ssrRenderStyle({ "color": "var(--ink-3)" })}" data-v-d7d46793>\u041F\u0440\u0435\u0434\u043F\u043E\u0447\u0438\u0442\u0430\u0435\u0442\u0435 \u043E\u0431\u0449\u0430\u0442\u044C\u0441\u044F \u043D\u0430\u043F\u0440\u044F\u043C\u0443\u044E?</p><a href="https://t.me/bugaev_web" target="_blank" rel="noopener noreferrer" class="inline-flex items-center gap-2 text-sm font-semibold transition-colors duration-150" style="${ssrRenderStyle({ "color": "var(--ink)" })}" data-v-d7d46793><svg width="15" height="15" viewBox="0 0 24 24" fill="currentColor" data-v-d7d46793><path d="M12 0C5.373 0 0 5.373 0 12s5.373 12 12 12 12-5.373 12-12S18.627 0 12 0zm5.894 8.221-1.97 9.28c-.145.658-.537.818-1.084.508l-3-2.21-1.447 1.394c-.16.16-.295.295-.605.295l.213-3.053 5.56-5.023c.242-.213-.054-.333-.373-.12l-6.871 4.326-2.962-.924c-.643-.204-.657-.643.136-.953l11.57-4.461c.537-.194 1.006.131.833.941z" data-v-d7d46793></path></svg> @bugaev_web \u2014 \u043D\u0430\u043F\u0438\u0441\u0430\u0442\u044C \u0432 Telegram \u2197 </a></div></div></div></section>`);
    };
  }
});
...
const __nuxt_component_9 = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-d7d46793"]]);
const _sfc_main$1 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<footer${ssrRenderAttrs(mergeProps({ style: { "background": "var(--dark)" } }, _attrs))}><div class="section-container py-14 md:py-16"><div class="flex flex-col md:flex-row md:items-start md:justify-between gap-8 mb-12"><div class="max-w-xs"><a href="#" class="flex items-center gap-3 mb-4 group"><div class="w-9 h-9 rounded-xl flex items-center justify-center flex-shrink-0 transition-transform duration-200 group-hover:scale-105" style="${ssrRenderStyle({ "background": "var(--accent)" })}"><svg width="16" height="16" viewBox="0 0 18 18" fill="none"><path d="M4 14L9 3L14 14H4Z" fill="var(--ink)"></path><circle cx="9" cy="9.5" r="1.8" fill="var(--ink)"></circle></svg></div><span class="font-bold text-base" style="${ssrRenderStyle({ "color": "#FFFFFF", "letter-spacing": "-0.02em", "font-family": "'Syne', sans-serif" })}">Bugaev Web</span></a><p class="text-sm leading-relaxed mb-6" style="${ssrRenderStyle({ "color": "rgba(255,255,255,0.35)" })}"> IT-\u043E\u0442\u0434\u0435\u043B + SMM \u043F\u043E\u0434 \u043A\u043B\u044E\u0447 \u0434\u043B\u044F \u0441\u0430\u043B\u043E\u043D\u043E\u0432 \u043A\u0440\u0430\u0441\u043E\u0442\u044B \u0438 beauty-\u043A\u043B\u0438\u043D\u0438\u043A \u0437\u0430\xA050\xA0000\xA0\u20BD/\u043C\u0435\u0441. </p><div class="flex items-center gap-2"><!--[-->`);
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    useHead({
      ...
      meta: [
        ...
        { property: "og:title", content: "Bugaev Web \u2014 IT-\u043E\u0442\u0434\u0435\u043B + SMM \u0434\u043B\u044F \u0441\u0430\u043B\u043E\u043D\u043E\u0432 \u043A\u0440\u0430\u0441\u043E\u0442\u044B" },
        {
          ...
          content: "\u0421\u0430\u0439\u0442, Telegram-\u0431\u043E\u0442, \u0441\u043E\u0446\u0441\u0435\u0442\u0438, CRM YCLIENTS \u0438 \u0430\u043D\u0430\u043B\u0438\u0442\u0438\u043A\u0430 \u043F\u043E\u0434 \u043A\u043B\u044E\u0447 \u0437\u0430 50 000 \u20BD/\u043C\u0435\u0441"
        },
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_Hero = _sfc_main$a;
      const _component_Features = _sfc_main$9;
      const _component_HowItWorks = _sfc_main$8;
      const _component_ForWho = _sfc_main$7;
      const _component_Pricing = _sfc_main$6;
      const _component_Advantages = _sfc_main$5;
      const _component_Testimonials = _sfc_main$4;
...
//# sourceMappingURL=index-BarvnT7t.mjs.map
